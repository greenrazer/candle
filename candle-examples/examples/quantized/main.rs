...
impl Which {
    ...
    fn tokenizer_repo(&self) -> &'static str {
        match self {
            ...
            Self::DeepseekR1_Llama8B => "deepseek-ai/DeepSeek-R1-Distill-Llama-8B"
        }
    }
}
...
fn main() -> anyhow::Result<()> {
    ...
    for prompt_index in 0.. {
        ...
        let eos_token = match args.which {
            ...
            Which::DeepseekR1_Llama8B => "<｜end▁of▁sentence｜>",
